...
//     return {
//       // Chỉ đưa 'id' vào map nếu nó không bị null
...
class GioHangItemSnapshot{
  ...
  static Future<int> xoa(GioHangItem item) async{
    try{
      await supabase.from("GioHang").delete().eq("uid", item.uid!).eq("fruitId", item.fruitId);
      return 1;
    }
    catch(e){
      print("Lỗi xoa vào giỏ hàng: ${e.toString()}");
      return 0;
    }
  }
}